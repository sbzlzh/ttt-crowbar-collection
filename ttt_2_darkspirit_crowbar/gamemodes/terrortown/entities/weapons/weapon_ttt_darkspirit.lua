...
if CLIENT then
    ...
    SWEP.Slot = 0
    SWEP.Weight = 5
    SWEP.Icon = "vgui/ttt/icon_darkspirit"
...
sound.Add({
    ...
    ['channel'] = CHAN_WEAPON,
    ['sound'] = {"weapons/ttt/dark_spirit/idle.wav"},
    ['pitch'] = {100, 100}
})
...
sound.Add({
    ...
    ['channel'] = CHAN_WEAPON,
    ['sound'] = {"weapons/ttt/dark_spirit/combo.wav"},
    ['pitch'] = {100, 100}
})
...
sound.Add({
    ...
    ['channel'] = CHAN_WEAPON,
    ['sound'] = {"weapons/ttt/dark_spirit/draw.wav"},
    ['pitch'] = {100, 100}
})
...
sound.Add({
    ...
    ['channel'] = CHAN_STATIC,
    ['sound'] = {"weapons/ttt/dark_spirit/slash1.wav"},
    ['pitch'] = {100, 100}
})
...
sound.Add({
    ...
    ['channel'] = CHAN_STATIC,
    ['sound'] = {"weapons/ttt/dark_spirit/slash2.wav"},
    ['pitch'] = {100, 100}
})
...
sound.Add({
    ...
    ['channel'] = CHAN_STATIC,
    ['sound'] = {"weapons/ttt/dark_spirit/slash3.wav"},
    ['pitch'] = {100, 100}
})
...
sound.Add({
    ...
    ['channel'] = CHAN_STATIC,
    ['sound'] = {"weapons/ttt/dark_spirit/slash4.wav"},
    ['pitch'] = {100, 100}
})
...
sound.Add({
    ...
    ['channel'] = CHAN_STATIC,
    ['sound'] = {"weapons/ttt/dark_spirit/dualslash1.wav"},
    ['pitch'] = {100, 100}
})
...
sound.Add({
    ...
    ['channel'] = CHAN_STATIC,
    ['sound'] = {"weapons/ttt/dark_spirit/dualslash2.wav"},
    ['pitch'] = {100, 100}
})
...
sound.Add({
    ...
    ['channel'] = CHAN_WEAPON,
    ['sound'] = {"weapons/ttt/dark_spirit/slash_hit1.wav"},
    ['pitch'] = {100, 100}
})
...
sound.Add({
    ...
    ['channel'] = CHAN_WEAPON,
    ['sound'] = {"weapons/ttt/dark_spirit/slash_hit2.wav"},
    ['pitch'] = {100, 100}
})
...
sound.Add({
    ...
    ['channel'] = CHAN_WEAPON,
    ['sound'] = {"weapons/ttt/dark_spirit/slash_hit3.wav"},
    ['pitch'] = {100, 100}
})
...
sound.Add({
    ...
    ['channel'] = CHAN_WEAPON,
    ['sound'] = {"weapons/ttt/dark_spirit/stone1.wav"},
    ['pitch'] = {100, 100}
})
...
sound.Add({
    ...
    ['channel'] = CHAN_WEAPON,
    ['sound'] = {"weapons/ttt/dark_spirit/stone2.wav"},
    ['pitch'] = {100, 100}
})
...
sound.Add({
    ...
    ['channel'] = CHAN_WEAPON,
    ['sound'] = {"weapons/ttt/dark_spirit/metal1.wav"},
    ['pitch'] = {100, 100}
})
...
sound.Add({
    ...
    ['channel'] = CHAN_WEAPON,
    ['sound'] = {"weapons/ttt/dark_spirit/metal2.wav"},
    ['pitch'] = {100, 100}
})
...
function SWEP:Reload()
    ...
    timer.Simple(0.6, function()
        if self:IsValid() then
            ...
            util.Effect("exp_darkspirit", effectdata) -- easy effect
        end
    end)
    ...
    if IsValid(hitEnt) or tr_main.HitWorld then
        ...
        if not (CLIENT and (not IsFirstTimePredicted())) then
            ...
            if hitEnt:IsPlayer() or hitEnt:GetClass() == "prop_ragdoll" then
                ...
                local sounds = {"DarkSpirit.HitFleshSlash1", "DarkSpirit.HitFleshSlash2", "DarkSpirit.HitFleshSlash3"}
                ...
                local wallSounds = {"DarkSpirit.HitWall1", "DarkSpirit.HitWall2", "DarkSpirit.HitMetal1", "DarkSpirit.HitMetal2"}
