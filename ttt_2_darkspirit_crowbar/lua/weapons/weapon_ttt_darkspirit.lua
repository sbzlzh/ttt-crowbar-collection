...
SWEP.WElements             = {
	["dark_spirit"] = { type = "Model", model = "models/weapons/tfa_cso/w_dark_spirit.mdl", bone =
	"ValveBiped.Bip01_L_Hand", rel = "", pos = Vector(8, -2, 20), angle = Angle(0, -180, 10), size = Vector(1, 1, 1), color =
