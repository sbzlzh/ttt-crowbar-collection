...
if CLIENT then
	SWEP.PrintName    = "Assassin Tomahawk"

	SWEP.Slot         = 0

	SWEP.Icon         = "vgui/ttt/icon_tomahawk"
...
killicon.Add("weapon_tomahawk", "vgui/ttt/icon_tomahawk", color_white)
...
function SWEP:DrawWorldModel()
	...
	offset = hand.Ang:Right() * self.Offset.Pos.Right + hand.Ang:Forward() * self.Offset.Pos.Forward +
